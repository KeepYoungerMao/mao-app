...
annotation class Phone(val message: String = "手机号格式不正确", val groups: Array<KClass<*>> = [], val payload: Array<KClass<out Payload>> = [])
...
annotation class Username(val message: String = "用户名格式不正确", val groups: Array<KClass<*>> = [], val payload: Array<KClass<out Payload>> = [])
...
annotation class IdCard(val message: String = "身份证格式不正确", val groups: Array<KClass<*>> = [], val payload: Array<KClass<out Payload>> = [])
